<?php
	#  为了适应Yii支持多云平台：SAE、BAE做了如下修改#
	#  1、继承CApplicationComponent
	#  2、将__construct()更名为setFile();
   # ========================================================================#
   #
...
class imageLib extends CApplicationComponent
{
...
## --------------------------------------------------------
  ...
  # Param in:   $rec: Application record. (We鈥檙e working with #2)
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/ 
  ...
  #
  {
    ...
    //1 : Chargement des ent锟絫es FICHIER
    $FILE = unpack("vfile_type/Vfile_size/Vreserved/Vbitmap_offset", fread($f1,14));
    if ($FILE['file_type'] != 19778) return FALSE;

    //2 : Chargement des ent锟絫es BMP
